...
export default function ExampleSelectionDiagram() {
  ...
  const getForecastNumber = (time: string): number => {
    ...
    if (totalMinutes >= 0 && totalMinutes < 6 * 60) return 1; // 12 AM - 6 AM
    if (totalMinutes >= 6 * 60 && totalMinutes < 12 * 60) return 2; // 6 AM - 12 PM
    if (totalMinutes >= 12 * 60 && totalMinutes < 18 * 60) return 3; // 12 PM - 6 PM
    return 4; // 6 PM+
  };
  ...
  const getForecastLabel = (fc: number): string => {
    switch (fc) {
      case 1: return 'FC1: 12 AM - 6 AM';
      case 2: return 'FC2: 6 AM - 12 PM';
      case 3: return 'FC3: 12 PM - 6 PM';
      case 4: return 'FC4: 6 PM+';
    ...
    <div className="w-full bg-gradient-to-br from-gray-50 to-gray-100 rounded-lg border border-gray-200 p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-300 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <label className="font-medium text-gray-700">Issuance Month (PT):</label>
          </div>
          <select
            value={selectedMonth}
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-300 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <label className="font-medium text-gray-700">Issuance Time (PT):</label>
          </div>
          <input
            type="time"
            value={selectedTime}
      ...
      <div className="space-y-4">
        ...
        <StepBox
          ...
          description="Based on the forecast issuance date"
        />
        ...
        <div className="bg-green-50 border-2 border-green-300 rounded-lg p-6">
          <div className="text-center">
            ...
            <div className="text-sm text-green-700 mt-2">
              A balanced mix of calm, moderate, and strong wind scenarios
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-sm text-blue-800">
          Wind patterns vary by season and issuance time, so matching the month and forecast slot keeps the examples
          relevant. Each set mixes calm, moderate, and strong wind cases to give the model a balanced reference.
        </p>
      </div>
      ...
      <details className="mt-4">
        ...
        <div className="mt-3 bg-gray-50 rounded p-4 text-xs font-mono space-y-2">
          <p><strong>Total Files:</strong> 48 (12 months × 4 forecast numbers)</p>
          <p><strong>Total Examples:</strong> 720 curated scenarios</p>
          <p><strong>Per File:</strong> 15 examples (diversity-filtered)</p>
          <p><strong>Years Covered:</strong> 2016-2024 (9 years of history)</p>
          <p><strong>Selection Criteria:</strong> Wind strength distribution, year diversity, data completeness</p>
        </div>
      </details>
    </div>
  );
