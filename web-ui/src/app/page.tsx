        ...
        <div className="bg-white rounded-lg shadow-lg px-2 py-6 mb-6">
          ...
          <div className="text-center mb-4">
            <h1 className="text-xl font-semibold text-gray-800">
              Forecast and Historic Wind (knots)
            </h1>
          </div>
            ...
            <>
              <div className="mb-3 mx-2 text-sm text-gray-700">
                <p>
                  ...
                  {getModelName(llmForecastMeta.model)}. For more details, see: <a href="#" rel="noopener noreferrer" className="text-[#005F73] hover:text-[#0A9396] underline">How It Works</a>
                </p>
              </div>
          ...
          <div className="mt-6 mx-2 bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-gray-700 leading-relaxed">
              This AI forecast is based on data from{' '}
              <a
              ...
              >
                NOAA&apos;s weather station AGXC1
              </a>
              {' '}located at the entrance of the port (Angels Gate) about a mile downwind of the launch for kitefoiling and windsurfing at Cabrillo Beach. The wind at this station is usually a few knots lower than the wind at the spot. Adjust your expectations accordingly.
            </p>
          </div>
