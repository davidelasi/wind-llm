...
/**
 * Get forecast time slots (displayed as end-of-hour, 11 AM - 6 PM)
 * Underlying data uses start-of-hour buckets (10-17).
 */
...
/**
 * Get forecast hour numbers (start-of-hour buckets 10 AM - 5 PM)
 * Aligned with training (10:00-18:00 window -> hours 10-17).
 */
