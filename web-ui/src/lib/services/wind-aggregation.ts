 ...
 * @returns Filtered array containing only hours 10-17 (10 AM - 6 PM end-of-hour labels, start-of-hour buckets)
 */
export function filterToForecastWindow(dataPoints: WindDataPoint[]): WindDataPoint[] {
  return dataPoints.filter(point => point.hour >= 10 && point.hour <= 17);
}
